...
### Fixed
- Risolto il problema per cui l'analisi non riusciva nella sezione Rete quando a un'interfaccia di rete mancava un nome logico
- Risolto il problema per cui alcune scritture casuali causavano il danneggiamento dei file crittografati

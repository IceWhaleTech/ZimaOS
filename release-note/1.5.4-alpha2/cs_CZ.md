...
### Fixed
- Opraven problém, kdy selhala analýza v části Síť, když síťovému rozhraní chyběl logický název
- Opraven problém, kdy některé náhodné zápisy způsobovaly poškození šifrovaných souborů

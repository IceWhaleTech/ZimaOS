...
### Fixed
- Opravený problém, kedy analýza zlyhala v sekcii Sieť, keď sieťovému rozhraniu chýbal logický názov
- Opravený problém, keď niektoré náhodné zápisy spôsobovali poškodenie šifrovaných súborov

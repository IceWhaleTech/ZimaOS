...
- Lade till en klick-app-cacherensningsfunktion
- Lade till inbyggd Markdown-redigerare

### Fixed
- Fixade onormal visning av "ZimaOS-HD" i filer när USB-enhet användes som systemdisk
- Fixat oförmåga att öppna zima-lagring på säkerhetskopieringssidan när USB-enhet används som systemdisk

## [1.5.2-beta2]
### Fixed
- Rettet et problem der sikkerhetskopieringsoppgaver ikke ble opprettet
...
- Lagt til ett-klikks program cache oppryddingsfunksjon
- Lagt til innebygd Markdown-editor

### Fixed
- Rettet unormal visning av "ZimaOS-HD" i filer når USB-stasjon ble brukt som systemdisk
- Fikset zima-lagring som ikke åpnes i sikkerhetskopiering ved oppstart fra en USB-stasjon.
...
- Avgrensede sikkerhetskopieringspolicybeskrivelser for større nøyaktighet og klarhet

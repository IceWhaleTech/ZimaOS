...
- Opravena nemožnost otevřít úložiště zima na stránce Záloha, když je jako systémový disk použit USB disk
- Opraven problém, kdy se úložná zařízení nezobrazovala v Souborech kvůli selhání analýzy typu disku
- Opraveny abnormality zobrazení, když cesty přípojných bodů obsahují mezery

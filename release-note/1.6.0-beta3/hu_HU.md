...
### Fixed
- Javítva az eszközazonosító megszerzésének módja
- Kijavítottuk azt a hibát, amely miatt a testreszabott lemezek nem jelentek meg teljesen
- Számos z-index rétegezési probléma kijavítva
- Kijavítottuk azt a problémát, amely miatt a vfat típusú lemezek jelenléte miatt a tárhely hiányzik
- Kijavítottuk azt a hibát, amely miatt az engedélyezett merevlemez formázása nem ment pontosan az adatbázisba
- Javítva a Lomtár pontatlan megjelenítése

### Improved
- Optimalizálta a hiányzó RAID-taglemezek meghatározásának logikáját
- Optimalizálta a mentési logikát a testreszabott lemezekhez

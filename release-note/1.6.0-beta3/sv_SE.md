...
### Fixed
- Fixade metoden för att få enhets-ID
- Fixade problemet där anpassade diskar inte visades helt
- Fixade flera z-index lagerproblem
- Fixade problemet där lagring verkade saknas på grund av närvaron av diskar av vfat-typ
- Fixade problemet där formatering av en aktiverad hårddisk inte sparades korrekt i databasen
- Fixat felaktig visning av papperskorgen

### Improved
- Optimerade logiken för att fastställa saknade RAID-medlemsdiskar
- Optimerade sparlogiken för anpassade diskar
...
### Fixed
- Fixade problemet där det korrekta diskindexet inte kunde erhållas sannolikt, vilket löste problemet med diskar som ibland försvann i WebUI.
- Fixade problemet där USB-enheter med partitioner inte kunde monteras automatiskt.
- Fixade problemet där anpassade enhetsbilder med transparent bakgrund visades som svarta.
...
- Optimerade visningslogiken för lagringsaktiveringsknappen för att göra det lättare att hitta.

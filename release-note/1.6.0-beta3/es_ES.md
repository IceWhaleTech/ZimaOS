...
### Fixed
- Se corrigió el método para obtener la identificación del dispositivo.
- Se solucionó el problema por el cual los discos personalizados no se mostraban completamente
- Se corrigieron varios problemas de capas del índice z
- Se solucionó el problema por el cual faltaba almacenamiento debido a la presencia de discos tipo vfat.
- Se solucionó el problema por el cual el formateo de un disco duro habilitado no se guardaba en la base de datos con precisión.
- Se corrigió la visualización inexacta de la Papelera de reciclaje.

### Improved
- Se optimizó la lógica para determinar los discos miembros RAID faltantes.
- Optimicé la lógica de guardado para discos personalizados.

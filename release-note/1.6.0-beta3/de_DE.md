...
### Fixed
- Die Methode zum Abrufen der Geräte-ID wurde korrigiert
- Das Problem wurde behoben, bei dem benutzerdefinierte Datenträger nicht vollständig angezeigt wurden
- Mehrere Probleme mit der Z-Index-Schichtung wurden behoben
- Das Problem wurde behoben, bei dem aufgrund des Vorhandenseins von Festplatten vom Typ vfat der Speicher fehlte
- Das Problem wurde behoben, bei dem die Formatierung einer aktivierten Festplatte nicht korrekt in der Datenbank gespeichert wurde
- Ungenaue Anzeige des Papierkorbs behoben

### Improved
- Die Logik zur Ermittlung fehlender RAID-Mitgliedsfestplatten wurde optimiert
- Die Speicherlogik für benutzerdefinierte Datenträger wurde optimiert

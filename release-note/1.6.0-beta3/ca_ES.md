...
### Fixed
- S'ha corregit el mètode per obtenir l'identificador del dispositiu
- S'ha solucionat el problema en què els discs personalitzats no es mostraven completament
- S'han solucionat diversos problemes de capes d'índex z
- S'ha solucionat el problema en què l'emmagatzematge semblava que faltava a causa de la presència de discs de tipus vfat
- S'ha solucionat el problema per què el format d'un disc dur habilitat no es desava a la base de dades amb precisió
- S'ha solucionat la visualització inexacta de la paperera de reciclatge

### Improved
- S'ha optimitzat la lògica per determinar els discos membres RAID que falten
- S'ha optimitzat la lògica d'estalvi per a discs personalitzats

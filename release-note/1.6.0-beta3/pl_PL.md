...
### Fixed
- Naprawiono metodę uzyskiwania identyfikatora urządzenia
- Naprawiono problem polegający na tym, że dyski niestandardowe nie były w pełni wyświetlane
- Naprawiono kilka problemów z warstwami indeksu Z
- Naprawiono problem polegający na tym, że brakowało miejsca na dysku z powodu obecności dysków typu vfat
- Naprawiono problem polegający na tym, że formatowanie włączonego dysku twardego nie zapisywało dokładnie w bazie danych
- Naprawiono niedokładne wyświetlanie Kosza

### Improved
- Zoptymalizowano logikę wykrywania brakujących dysków członkowskich RAID
- Zoptymalizowano logikę zapisywania dla niestandardowych dysków

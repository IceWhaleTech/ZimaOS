...
- Riješen problem kod kojeg se otkazivanjem SMB dijeljenja za mapu otkazuju i dijeljenja za podmape
- Ispravljena greška pregleda za neke HEIC datoteke u Datotekama
- Riješen problem s datotekama utičnice i cijevi u rezervnim direktorijima

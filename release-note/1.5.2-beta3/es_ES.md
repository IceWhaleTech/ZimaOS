## [1.5.2-beta3]
### Fixed
- Se solucionó un problema por el cual el cliente de PC no podía crear copias de seguridad.

### Optimized
- Optimizado el rango seleccionable de fuentes de respaldo
- Se mejoró la redacción de las descripciones de las políticas de respaldo.

## [1.5.2-beta2]
### Fixed
- Se solucionó un problema por el cual las tareas de respaldo no se podían crear

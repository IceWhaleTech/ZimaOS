## [1.5.2-beta3]
### Fixed
- Correction d'un problème où le client PC ne parvenait pas à créer des sauvegardes

### Optimized
- Optimisation de la gamme sélectionnable de sources de sauvegarde
- Amélioration de la formulation des descriptions des politiques de sauvegarde

## [1.5.2-beta2]
### Fixed
- Correction d'un problème où les tâches de sauvegarde ne parvenaient pas à être créées

## [1.5.2-beta3]
### Fixed
- Fixed an issue where the PC client failed to create backups

### Optimized
- Optimized the selectable range of backup sources
- Improved the wording of backup policy descriptions

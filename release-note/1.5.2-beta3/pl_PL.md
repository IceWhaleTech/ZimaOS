## [1.5.2-beta3]
### Fixed
- Naprawiono problem polegający na tym, że klient PC nie tworzył kopii zapasowych

### Optimized
- Zoptymalizowano wybrany zakres źródeł kopii zapasowych
- Poprawiono sformułowanie opisów zasad tworzenia kopii zapasowych

## [1.5.2-beta2]
### Fixed
- Naprawiono problem polegający na tym, że nie udało się utworzyć zadań kopii zapasowych
...
- Naprawiono nieotwieranie się Zima-Storage w Kopii zapasowej podczas uruchamiania z dysku USB.

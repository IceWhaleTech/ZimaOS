## [1.5.2-beta3]
### Fixed
- Es wurde ein Problem behoben, bei dem der PC-Client keine Backups erstellen konnte

### Optimized
- Der auswählbare Bereich der Backup-Quellen wurde optimiert
- Der Wortlaut der Beschreibungen der Backup-Richtlinien wurde verbessert

## [1.5.2-beta2]
### Fixed
- Es wurde ein Problem behoben, bei dem Backup-Aufgaben nicht erstellt werden konnten

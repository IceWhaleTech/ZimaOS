## [1.5.2-beta3]
### Fixed
- S'ha solucionat un problema en què el client de l'ordinador no podia crear còpies de seguretat

### Optimized
- S'ha optimitzat el rang seleccionable de fonts de còpia de seguretat
- S'ha millorat la redacció de les descripcions de les polítiques de còpia de seguretat

## [1.5.2-beta2]
### Fixed
- S'ha solucionat un problema en què les tasques de còpia de seguretat no es podien crear
...
- S'han corregit les anomalies de visualització quan els camins dels punts de muntatge contenien espais
- S'ha corregit el càlcul de mida anormal en migrar directoris que contenen espais
- S'han corregit els conflictes de noms de projecte quan s'importava projectes amb docker-cli
- S'ha solucionat un problema d'estabilitat que provocava la terminació inesperada del servei avahi-daemon

### Optimized
- Missatges d'indicació predeterminats millorats després d'importar contenidors mitjançant l'execució de Docker

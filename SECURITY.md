...
|--------|-------|---------------------|------------------|--------|---------------|------------|
| CVE-2026-28798 | Arbitrary internal service access via /v1/sys/proxy when Cloudflare Tunnel is enabled on ZimaOS | 9.1 High | ZimaOS ≤ v1.5.0 | Fixed | [View Advisory](https://github.com/IceWhaleTech/ZimaOS/security/advisories/GHSA-vqqj-f979-8c8m) |  DrDark1999 |
